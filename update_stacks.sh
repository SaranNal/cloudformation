...
stacks[network]="https://test-cloudformation-template-clone-stack.s3.amazonaws.com/network-stack/RootStack.yaml ${COMMON_PARAMETERS} ParameterKey=CodeStarConnectionID,ParameterValue=${CodeStarConnectionID}"
